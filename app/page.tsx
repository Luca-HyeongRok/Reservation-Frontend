...
export default function HomePage() {
  const { reservations, isLoading, error, addReservation } = useReservations();
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-6 py-10 bg-slate-50">
